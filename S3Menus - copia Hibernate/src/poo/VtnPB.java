...
public class VtnPB extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_btnAceptarActionPerformed
        if (btnAceptar.getText().equals("Buscar"))
        {
            ...
            if (folio != null)
            {
                ...
                Perecederos ap = p.findPerecederos(Integer.parseInt(folio));
                    ...
                    if (ap != null)
                    {
                        ...
                        tfExistencias.setText(String.valueOf(ap.getExistencias()));
                        tfFechaCad.setText(ap.getFechaCad());
                    } else
                    {
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnPB.class
