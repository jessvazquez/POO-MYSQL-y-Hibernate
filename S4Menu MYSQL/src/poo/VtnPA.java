...
public class VtnPA extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        setTitle("Altade productos perecederos");
    ...
    {//GEN-HEADEREND:event_btnAceptarActionPerformed
        ...
        int existencias=0 ;
        while(!Validaciones.verificaEntero(tfExistenacias))
        {
            Mensaje.error(this, "Se esperaba un entero");
            CtrlInterfaz.selecciona(tfExistenacias);
        }
        existencias = Integer.parseInt(tfExistenacias.getText());
        String fechaCad = tfFechaCad.getText();
        Perecederos obj= new Perecederos(fechaCad, nom, existencias);
        //VtnP.p=ManipulaProductos.inserta(VtnP.p, obj);
        Connection con = ManipulaDB.conecta(this);
        if(con != null)
        {
            Querys sql = new Querys();
            sql.Insertar(con, "Perecederos", "null,'"+nom+
                         "',"+existencias+",'"+fechaCad+
                         "'");
    ...
    {//GEN-HEADEREND:event_btnCancelarActionPerformed
        ...
        CtrlInterfaz.habilita(false, tfExistenacias,tfFechaCad,btnAceptar);
